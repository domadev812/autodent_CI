...
$config['tables']['groups']          = 'users_role_groups';
 ...
 */
$config['site_title']                 = "autodent.com";       // Site Title, example.com
$config['admin_email']                = "admin@autodent.com"; // Admin Email, admin@example.com

$config['default_group']              = 'tech';      // Default group, use name
